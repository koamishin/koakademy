...
it('publishes immutable SHA images to both registries before moving channel aliases', function (): void {
    ...
    expect($delivery)
        ...
        ->toContain('promote_mutable_franken_pair edge-frankenphp')
        ->toContain('promote_mutable_franken_pair latest-franken')
        ->toContain('promote_mutable_franken_pair "${major}.${minor}-franken"')
        ->toContain('promote_mutable_franken_pair "${major}-franken"')
        ->not->toContain('promote_mutable_franken_pair edge\n')
        ->not->toContain('promote_mutable_franken_pair latest\n')
