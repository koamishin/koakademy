...
This guide covers native development and testing. Production operators should use [Getting Started](./getting-started/installation/) instead.
...
See [Architecture](./getting-started/architecture/) for boundaries and production dependencies.
