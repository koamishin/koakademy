...
return [
    ...
    */
    ...
    'default' => env('STATION_DRIVER', 'redis'),
    ...
    */
    ...
    'supervisors' => [
        'default' => [
            'connection' => 'redis',
            'queues' => ['default', 'assessments'],
            'balance' => 'auto', // 'auto', 'simple', 'priority'
            'processes' => (int) env('STATION_PROCESSES', 3),
            'tries' => (int) env('STATION_TRIES', 1),
            'timeout' => (int) env('STATION_TIMEOUT', 60),
            'memory' => (int) env('STATION_MEMORY', 512),
            'sleep' => 3,
            'rest' => 0,
        ...
        'pdf' => [
            ...
            'balance' => 'auto',
            'processes' => (int) env('STATION_PDF_PROCESSES', 2),
            'tries' => (int) env('STATION_PDF_TRIES', 1),
            'timeout' => (int) env('STATION_PDF_TIMEOUT', 3600),
            'memory' => (int) env('STATION_PDF_MEMORY', 2048),
            'sleep' => 3,
            'rest' => 0,
            'max_time' => (int) env('STATION_PDF_MAX_TIME', 0),
            'max_jobs' => (int) env('STATION_PDF_MAX_JOBS', 0),
            'force' => false,
        ],
    ],
    ...
    */
    ...
    'dashboard' => [
        ...
        'middleware' => ['web', 'auth', App\Http\Middleware\UseStationInertiaRootView::class],
