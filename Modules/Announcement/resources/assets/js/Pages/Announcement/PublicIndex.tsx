        ...
        <PortalLayout user={user}>
            ...
            >
                <Card className={cn(dashboardPanelClass, "relative overflow-hidden")}>
                    ...
                    <CardContent className="relative z-10 flex flex-col justify-between gap-5 p-4 sm:p-5 md:flex-row md:items-end md:p-6">
                        <div className="space-y-2.5 sm:space-y-3">
                            <div className="text-primary flex items-center gap-2 font-bold">
                                ...
                                <span className="text-muted-foreground text-[10px] font-bold tracking-widest uppercase sm:text-[11px]">Student Updates</span>
                            </div>
                            <div>
                                ...
                                <p className="text-muted-foreground mt-1.5 max-w-xl text-sm leading-relaxed sm:text-base">
                                    Stay updated with the latest news and important notices for your academic period.
                                </p>
                            </div>
                        </div>
                        <div className="group border-border/60 bg-background/40 relative overflow-hidden rounded-xl border px-5 py-3 transition-all duration-300 hover:border-primary/30 sm:px-6 sm:py-4">
                            ...
                            <p className="text-foreground mt-0.5 text-2xl font-extrabold tabular-nums tracking-tight sm:mt-1 sm:text-3xl">{announcements.length}</p>
                        </div>
                    </CardContent>
                </Card>
